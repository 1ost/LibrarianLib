...
public object BaseRenderStates {
    ...
    ) : RenderState.State(Identifier.of("liblib_albedo:cull")) {
        override fun apply() {
            if (enabled) {
    ...
    ) : RenderState.State(Identifier.of("liblib_albedo:depth_test")) {
    ...
    ) : RenderState.State(Identifier.of("liblib_albedo:write_mask")) {
