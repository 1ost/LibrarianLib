...
import com.teamwizardry.librarianlib.glitter.testmod.modules.HeldItemConditionalRenderModule
import net.minecraft.entity.Entity
import net.minecraft.util.math.vector.Vector3d
import net.minecraft.util.math.MathHelper

object PhysicsOnlySystem : TestSystem("physics_only") {
    override fun configure() {
        ...
        renderModules.add(
            HeldItemConditionalRenderModule(
                loc("ll-glitter-test:physics_only_entity"),
