...
private object RenderStateAccess : RenderState("", Runnable {}, Runnable {}) {
    ...
    val _ZERO_ALPHA: AlphaState = NO_ALPHA
    val _DEFAULT_ALPHA: AlphaState = DEFAULT_ALPHA
    val _HALF_ALPHA: AlphaState = MIDWAY_ALPHA
    val _SHADE_DISABLED: ShadeModelState = FLAT_SHADE
    val _SHADE_ENABLED: ShadeModelState = SMOOTH_SHADE
    ...
    val _LIGHTMAP_ENABLED: LightmapState = LIGHTMAP
    val _LIGHTMAP_DISABLED: LightmapState = NO_LIGHTMAP
    val _OVERLAY_ENABLED: OverlayState = OVERLAY
    val _OVERLAY_DISABLED: OverlayState = NO_OVERLAY
    val _DIFFUSE_LIGHTING_ENABLED: DiffuseLightingState = DIFFUSE_LIGHTING
    val _DIFFUSE_LIGHTING_DISABLED: DiffuseLightingState = NO_DIFFUSE_LIGHTING
    val _CULL_ENABLED: CullState = CULL
    val _CULL_DISABLED: CullState = NO_CULL
    val _DEPTH_ALWAYS: DepthTestState = NO_DEPTH_TEST
    val _DEPTH_EQUAL: DepthTestState = EQUAL_DEPTH_TEST
    val _DEPTH_LEQUAL: DepthTestState = LEQUAL_DEPTH_TEST
